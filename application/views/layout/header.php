...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>/vuexy/app-assets/vendors/css/charts/apexcharts.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>/vuexy/app-assets/vendors/css/extensions/toastr.min.css">
    <!-- END: Vendor CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>/vuexy/app-assets/css/plugins/extensions/ext-component-toastr.css">
    <!-- END: Page CSS-->

    <!-- BEGIN: Custom CSS-->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>/vuexy/assets/css/style.css">
    <!-- END: Custom CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>/vuexy/app-assets/vendors/css/tables/datatable/dataTables.bootstrap5.min.css">
    ...
    <script src="<?php echo base_url() ?>/vuexy//app-assets/vendors/js/tables/datatable/jquery.dataTables.min.js"></script>
