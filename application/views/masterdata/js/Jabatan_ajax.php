<script type="text/javascript">
  ...
  function save(){
    ...
    $.ajax({
        type: 'POST',
        url: "<?php echo base_url('masterdata/jabatan/save'); ?>",
        data:data,
        dataType : 'json',
        processData: false,
        contentType: false,
  ...
  function edit(id){
    $.ajax({
        type: 'POST',
        url: "<?php echo base_url('masterdata/jabatan/getJabatanById'); ?>",
        data:{id:id},
        dataType : 'json',
  ...
  var dataTable = $('.datatables-basic').DataTable({  
     ...
     "order":[],  
     "ajax":{  
          url:"<?php echo base_url('masterdata/jabatan/getJabatan'); ?>",  
          type:"POST"  
     },  
     "columnDefs":[  
          {  
