...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>/vuexy/app-assets/css/plugins/forms/form-validation.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>/vuexy/app-assets/css/pages/authentication.css">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
                            ...
                            <div class="card-body">
                                ...
                                <form class="auth-login-form mt-2" action="<?php echo base_url('login') ?>" method="POST">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" class="form-control" id="login-email" name="username" placeholder="Username NIK" aria-describedby="login-email" tabindex="1" autofocus />
                                    </div>
    ...
    <script src="<?php echo base_url() ?>/vuexy/app-assets/vendors/js/forms/validation/jquery.validate.min.js"></script>
    <!-- END: Page Vendor JS-->
    ...
    <!-- BEGIN: Page JS-->
    <script src="<?php echo base_url() ?>/vuexy/app-assets/js/scripts/pages/auth-login.js"></script>
    <!-- END: Page JS-->
